...
namespace UnitTest.Domain.BusinessObject.勘定科目
{
    ...
    public class 仕訳列クラステスト
    {
        ...
        public void すべての仕訳の合計金額()
        {
            ...
            Assert.AreEqual(0m, 仕訳列.貸借別合計金額を取得する(AccountingSystem.Domain.BusinessObject.貸借.区分.借方).値);
            Assert.AreEqual(0m, 仕訳列.貸借別合計金額を取得する(AccountingSystem.Domain.BusinessObject.貸借.区分.貸方).値);
