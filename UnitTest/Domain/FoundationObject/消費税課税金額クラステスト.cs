...
using AccountingSystem.Domain.FoundationObject;
...
namespace UnitTest.Domain.FoundationObject
{
    ...
    public class 消費税課税金額クラステスト
    {
        ...
        public void 基本テスト()
        {
            ...
            Assert.AreEqual("8%", 課税取引1.税率.パーセント表示);
            ...
            消費税課税金額 課税取引3 = new 消費税課税金額(new 金額(12345), 消費税課税金額.計算方法.課税対象金額,0.08m);
            ...
            消費税課税金額 課税取引4 = new 消費税課税金額(new 金額(13332), 消費税課税金額.計算方法.税込金額,0.08m);
