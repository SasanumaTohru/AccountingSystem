...
namespace UnitTest.Domain.FoundationObject
{
    ...
    public class 消費税課税金額クラステスト
    {
        ...
        public void 基本テスト()
        {
            消費税課税金額 課税取引1 = new 消費税課税金額(new 金額(100), 消費税課税金額.入力値.課税対象金額);
            ...
            消費税課税金額 課税取引2 = new 消費税課税金額(new 金額(108), 消費税課税金額.入力値.税込金額);
            ...
            消費税課税金額 課税取引3 = new 消費税課税金額(new 金額(12345), 消費税課税金額.入力値.課税対象金額);
            ...
            消費税課税金額 課税取引4 = new 消費税課税金額(new 金額(13332), 消費税課税金額.入力値.税込金額);
