...
namespace 会計システム.Domain.FoundationObject
{
    public class 消費税課税金額
    {
        ...
        public 消費税課税金額(PrimitiveObject.金額 金額, 入力値 入力値 = 入力値.課税対象金額 )
        {
            m_適用消費税率 = new 消費税率();
            switch ( 入力値 )
            {
        ...
        public PrimitiveObject.金額 課税対象金額()
        {
            return m_課税対象金額;
        }

        public PrimitiveObject.金額 消費税額()
        {
            return m_消費税額;
        }

        public PrimitiveObject.金額 税込金額()
        {
            return new PrimitiveObject.金額(m_課税対象金額.値() + m_消費税額.値());
        }
